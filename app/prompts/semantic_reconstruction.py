...
MULTI-VISUAL CARDS:
- Одна карточка может иметь 2+ смысловые иллюстрации: препарат+симптом, продукт+орган, причина+следствие.
- Не объединяй разные смысловые иллюстрации в один PNG. Создай отдельные visual_entity и semantic_png_plan для каждой.
- В card укажи primary_png_id для главного предмета и secondary_png_id для второго визуала; png_id оставь равным primary_png_id для совместимости.
- Если вторых визуалов нет, используй обычный один png_id.
...
Проанализируй медицинскую инфографику и верни compact v43.8 JSON.
...
{
  "schema_version": "v43.8-multi-visual-cards",
  ...
  "design_blueprint": {
    ...
    "cards": [
      {"card_id": "card_001", "entity_id": "entity_001", "png_id": "png_001", "primary_png_id": "png_001", "secondary_png_id": null, "png_ids": ["png_001"], "title": "", "short_text": "max 130 chars", "examples": ["optional examples, max 5"], "design_instruction": "max 70 chars"}
    ],
    "footer_blocks": [
...
- Если у карточки 2 смысловые картинки, создай 2 PNG и свяжи их через primary_png_id/secondary_png_id.
