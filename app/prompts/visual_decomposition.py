...
- If the useful visual has multiple parts, return multiple components. Example:
  one component for the bite mark and one component for the insect.
  ...
  "units": [
    {
      ...
      "components": [
        {
          "component_id": "...",
          "type": "bite_photo | insect_icon | text_label | background | watermark | social_ui | other",
          "action": "preserve | remove | recreate | replace | generate_new",
          "boundary_type": "circle | square | rectangle | none | unknown",
