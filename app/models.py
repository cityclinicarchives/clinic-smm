...
class IntakeContentItem(Base):
    __tablename__ = "intake_content_items"

    id = Column(Integer, primary_key=True, index=True)
    title = Column(String(255), nullable=True)
    rubric = Column(String(50), default="expert", nullable=False)
    content_type = Column(String(50), default="manual", nullable=False)
    status = Column(String(50), default="draft", nullable=False)
    source = Column(String(100), default="telegram", nullable=True)
    source_chat_id = Column(String(100), nullable=True)
...
class IntakeContentFile(Base):
    __tablename__ = "intake_content_files"

    id = Column(Integer, primary_key=True, index=True)
    content_item_id = Column(Integer, ForeignKey("intake_content_items.id"), nullable=False, index=True)
    media_type = Column(String(100), nullable=True)
