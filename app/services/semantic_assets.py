...
def _draw_content_card(
    ...
    draw.rounded_rectangle((icon_x + slot_pad, icon_y + slot_pad, icon_x + icon_box - slot_pad, icon_y + icon_box - slot_pad), radius=max(12, icon_box//7), fill="#FFFFFF", outline=preset.get("card_border", "#DCEAF7"), width=1)
