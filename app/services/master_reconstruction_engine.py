...
def _payload_from_master_json(data: dict[str, Any]) -> ProjectStatePayload:
    ...
    payload.analysis_state = data.get("analysis_state") or {}
    payload.semantic_units = data.get("semantic_units") or []
    payload.unit_decisions = data.get("unit_decisions") or []
    payload.final_units = data.get("final_units") or []
    payload.component_map = data.get("component_map") or []
    payload.layout_blueprint = data.get("layout_blueprint") or {}
    payload.image_tasks = data.get("image_tasks") or []
    payload.post_brief = data.get("post_brief") or {}
