...
def _compact_audit(audit: Any) -> Dict[str, Any]:
    """Keep audit as support for smart_blocks/footer, not as a card rewrite driver."""
    audit = audit if isinstance(audit, dict) else {}
    out = {
        "risks": _compact_list(audit.get("risks"), 2, 110),
        "minimal_corrections": _compact_list(audit.get("minimal_corrections") or audit.get("corrections"), 2, 110),
        "footer_warnings": _compact_list(audit.get("footer_warnings") or audit.get("required_warnings"), 2, 150),
    }
