...
def ensure_database_schema() -> None:
    ...
    statements = [
        ...
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS title VARCHAR(255)",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS rubric VARCHAR(50) DEFAULT 'expert'",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS content_type VARCHAR(50) DEFAULT 'manual'",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'draft'",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS source VARCHAR(100) DEFAULT 'telegram'",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS source_chat_id VARCHAR(100)",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS source_message_id VARCHAR(100)",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS text_content TEXT",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS caption TEXT",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS notes TEXT",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS raw_meta TEXT",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE intake_content_items ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS content_item_id INTEGER",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS media_type VARCHAR(100)",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS telegram_file_id TEXT",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS file_name TEXT",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS local_path TEXT",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS mime_type VARCHAR(100)",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS size_bytes INTEGER",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS raw_meta TEXT",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE intake_content_files ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",
        ...
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS asset_id INTEGER",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS project_state_id INTEGER",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS schema_version VARCHAR(100)",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS analysis_json TEXT",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS file_path TEXT",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS estimated_cost_usd VARCHAR(50)",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS input_tokens INTEGER",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS output_tokens INTEGER",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS total_tokens INTEGER",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE semantic_analyses ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",


        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS asset_id INTEGER",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS project_state_id INTEGER",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS kind VARCHAR(100)",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS file_name TEXT",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS local_path TEXT",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS storage_backend VARCHAR(50) DEFAULT 'local'",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS storage_key TEXT",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS public_url TEXT",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS mime_type VARCHAR(100)",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS size_bytes INTEGER",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE semantic_asset_files ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",
    ]
