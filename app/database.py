...
def ensure_database_schema() -> None:
    ...
    statements = [
        ...
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS asset_id INTEGER",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS created_post_id INTEGER",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS content_type VARCHAR(255)",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS original_title TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS final_title TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS title_evaluation TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS preserved_elements TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS corrected_elements TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS medical_audit TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS additions TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS infographic_structure TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS visual_strategy TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS post_topic VARCHAR(500)",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS post_text TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS image_prompt TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS reconstruction_spec TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS analysis TEXT",
        "ALTER TABLE content_reconstructions ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",

        "ALTER TABLE project_states ADD COLUMN IF NOT EXISTS asset_id INTEGER",
        "ALTER TABLE project_states ADD COLUMN IF NOT EXISTS reconstruction_id INTEGER",
