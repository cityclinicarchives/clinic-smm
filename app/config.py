...
class Settings(BaseSettings):
    ...
    # Для маленьких Semantic PNG генерируем 1024x1024 в дешевом качестве, затем локально уменьшаем.
    openai_image_quality: str = "low"
    # For GPT Image edits with a reference image. low keeps cost lower; set high manually if needed.
    ...
    # Persistent object storage for generated artifacts (Cloudflare R2/S3-compatible).
    # STORAGE_BACKEND can be: local or r2. When local, R2 settings are ignored.
